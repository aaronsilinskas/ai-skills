...
Invoke the `grilling` skill via the Skill tool to run the interview, using the `domain-modeling` skill to keep the domain docs (`domain.md` map + `domain-language.md` glossary) current as decisions crystallise.
