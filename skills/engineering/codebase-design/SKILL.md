...
- **"Interface" as just a type signature or a class's public methods** (e.g. a language's `interface`/`Protocol` construct): too narrow — interface here includes every fact a caller must know.
